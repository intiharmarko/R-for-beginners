# 5.6 User defined functions (UDF)

# 5.6.1 Write your first function
power <- function(x,a){
  y <- x^a
  return(y)
}
...
# 5.6.2 Default function arguments
...
# 5.6.3 Return single or multiple arguments
...
# 5.6.4 Ellipses "..." - additional func parameters
...
# 5.6.6 Recursive functions (Recursion)
...
# 5.6.7 call function from a different script
